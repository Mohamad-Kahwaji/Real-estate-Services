...
.al-field .input-group:focus-within .form-control { border-color: #696cff; box-shadow: 0 0 0 3px rgba(105,108,255,.12); }
...
.al-signin-link a {
    color: #696cff; font-weight: 700; text-decoration: none;
}
