...
.al-brand-name {
    font-size: 20px; font-weight: 800; color: #3b3551;
}
...
.al-field .input-group:focus-within .input-group-text {
    border-color: var(--role-accent);
    box-shadow: 3px 0 0 0 rgba(var(--role-accent-rgb),.12), 0 0 0 3px rgba(var(--role-accent-rgb),.12);
}
...
<div class="al-wrapper">
    ...
    <div class="al-panel">
        ...
        <div class="al-panel-title">Admin Control Panel</div>
        <div class="al-panel-sub">
            Secure access to manage your system, administrators, and platform settings.
        </div>
        ...
        <div class="al-badge mt-3">
            <div class="al-badge-icon"><i class="ri ri-bar-chart-grouped-line"></i></div>
            <div class="al-badge-text">
                <strong>Full Dashboard Access</strong>
                <span>Monitor everything in one place</span>
            </div>
        </div>
    </div>
    ...
    <div class="al-form-side">
        <div class="al-form-box">
            ...
            <h4 class="al-heading">Welcome back, Admin</h4>
            <p class="al-sub">Sign in to access your dashboard</p>
            ...
            {{-- Form --}}
            <form action="{{ route('logina.store') }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn-al-login">
                    <i class="ri ri-login-box-line me-2"></i>Sign In
                </button>
