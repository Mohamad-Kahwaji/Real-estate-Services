...
<div class="al-wrapper">
    ...
    <div class="al-panel">
        <div class="al-panel-icon"><i class="ri ri-vip-crown-2-line"></i></div>
        <div class="al-panel-title">Super Admin Password Reset</div>
        <div class="al-panel-sub">Verify your identity and set a new secure password.</div>

        <div class="al-step">
            <div class="al-step-num">1</div>
            <div class="al-step-text">Enter your super admin email</div>
        </div>
    ...
    <div class="al-form-side">
        <div class="al-form-box">
            ...
            <p class="al-sub">Enter your super admin email and we'll send you a verification code.</p>
            ...
            <form action="{{ route('superadmin.forgot-password.send') }}" method="POST">
                @csrf
                <div class="al-field">
            ...
            <div class="al-switch">
                ...
                <a href="{{ route('loginsa.create') }}">Back to Sign In</a>
            </div>
