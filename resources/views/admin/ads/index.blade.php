...
.btn-add {
    ...
    text-decoration:none; box-shadow:0 4px 14px rgba(var(--role-accent-rgb),.35); transition:.2s;
}
...
.ad-card:hover { transform:translateY(-3px); box-shadow:0 12px 34px rgba(var(--role-accent-rgb),.14); }
...
<div class="page-hdr">
    <div>
        <h4><i class="ri ri-advertisement-line" style="color:var(--role-accent);margin-left:8px;"></i>{{ __('app.ads') }}</h4>
        <p>{{ __('app.ads_desc') }}</p>
    </div>
...
<div style="text-align:center;padding:80px 20px;background:#fff;border-radius:20px;border:1.5px dashed #d4d5ff;">
    <i class="ri ri-advertisement-line" style="font-size:52px;color:var(--role-accent-light);display:block;margin-bottom:14px;"></i>
