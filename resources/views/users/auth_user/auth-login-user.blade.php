...
.auth-form-box{
    ...
    box-shadow:0 8px 40px rgba(var(--role-accent-rgb),.1);
}
...
.forgot-link{font-size:13px;color:var(--role-accent);font-weight:600;text-decoration:none;}
...
.btn-login:hover{transform:translateY(-1px);box-shadow:0 10px 28px rgba(var(--role-accent-rgb),.45);}
